    ...
    internal class ScreenSpaceAmbientOcclusion : ScriptableRendererFeature
    {
        ...
        private class ScreenSpaceAmbientOcclusionPass : ScriptableRenderPass
        {
            ...
            internal ScreenSpaceAmbientOcclusionPass()
            {
                ...
                m_SSAOTexture1ID = RTHandles.Alloc(Shader.PropertyToID("_SSAO_OcclusionTexture1"), "_SSAO_OcclusionTexture1");
                m_SSAOTexture2ID = RTHandles.Alloc(Shader.PropertyToID("_SSAO_OcclusionTexture2"), "_SSAO_OcclusionTexture2");
                m_SSAOTexture3ID = RTHandles.Alloc(Shader.PropertyToID("_SSAO_OcclusionTexture3"), "_SSAO_OcclusionTexture3");
            }
