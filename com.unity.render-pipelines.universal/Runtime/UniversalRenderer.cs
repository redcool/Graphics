...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            m_ColorRTBufferSystem.SetReferenceSize(cameraData.cameraTargetDescriptor.width, cameraData.cameraTargetDescriptor.height, (MSAASamples)cameraData.cameraTargetDescriptor.msaaSamples);
            ...
            if (lastCameraInTheStack)
            {
                ...
                {
                    m_FinalBlitPass.Setup(cameraTargetDescriptor, m_ActiveCameraAttachments.color);
